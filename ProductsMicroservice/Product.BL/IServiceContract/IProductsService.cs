...
namespace Product.BL.IServiceContract;
...
public interface IProductsService
{
    ...
    Task<List<ProductResponse?>> GetProductsByCondition(Expression<Func<Products.DAL.Entities.Product, bool>> conditionExpression);
    ...
    Task<ProductResponse?> GetProductByCondition(Expression<Func<Products.DAL.Entities.Product, bool>> conditionExpression);
